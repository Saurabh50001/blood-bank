...
<html>
	<head>
		...
		<title>Forgot Password - E-RAKT KOSH MANAGEMENT SYSTEM
</title>
		...
		<div>
			...
			<center style="background-color: aqua;">
				<div style="width: 500px; border: 2px solid #E65100; margin-top: 35px; margin-bottom: 35px; background-color: #FFA726; padding: 20px">
					<h1 style="background-image: linear-gradient(red, #262626); color: white; padding: 10px">Forgot Password</h1>
