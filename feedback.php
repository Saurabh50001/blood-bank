...
<html>
	<head>
		...
		<title>Feedback - E-RAKT KOSH MANAGEMENT SYSTEM
</title>
	...
	<body>
		<div>
			...
			<center style="background-color: aqua;">
				<div style="width: 500px; height: 520px; border: 2px solid #3E2723; margin-top: 35px; margin-bottom: 35px; background-color: beige ; padding: 15px; border-top-right-radius: 25px; border-bottom-left-radius: 25px; box-shadow: 8px 8px #E0E0E0">
					<h1 style="background-image: linear-gradient(yellow, orangered); color: white; padding: 10px">Feedback</h1>
					
					<form name="search_form" method="post" action="" style="width: 100%; margin-top: 40px;" enctype="multipart/form-data">
						<table>
							<tr>
								<td>Name:</td>
								<td><input type="text" name="TxtDonorName" style="margin-bottom: 10px;font-size: 16px" onclick="enterevent4()"></td>
							</tr>
							
							<tr>
								<td>Mobile No.:</td>
								<td><input type="text" name="TxtMobile" style="margin-bottom: 10px;font-size: 16px" onclick="enterevent5()"></td>
							</tr>
							
							<tr>
								<td>Email:</td>
								<td><input type="text" name="TxtEmail" style="margin-bottom: 10px;font-size: 16px" onclick="enterevent6()"></td>
							</tr>
							<tr>
								<td>Subject:</td>
								<td><input type="text" name="TxtSubject" style="margin-bottom: 10px;font-size: 16px" onclick="enterevent7()"></td>
							</tr>
							<tr>
								<td>Message:</td>
								<td>
									<textarea rows="5" cols="30" style="margin-bottom: 10px;font-size: 16px" name="TxtMessage" onclick="enterevent8()"></textarea>
								</td>
							</tr>
