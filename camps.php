	...
	<body>
		<div>
			...
			<center style="background-color: aqua;">
				<div style="width: 100%; border: 2px solid orangered; margin-top: 35px; margin-bottom: 35px; padding: 20px; border-radius: 25px; ">
					<img src="images/gallery.png" width="400px" height="60px">
			...
			?>
			<tr>
				<td><?php echo $row["campid"];?></td>
				<td><?php echo $row["name"];?></td>
				<td><?php echo $row["organisedby"];?></td>
