...
<html>
	<head>
		...
		<title>Contact Us Report - E-RAKT KOSH MANAGEMENT SYSTEM
</title>
		...
		<div>
			...
			<center style="background-color: aqua;">
				<div style="width: 90%; border: 2px solid orangered; margin-top: 35px; margin-bottom: 35px; padding: 20px; border-radius: 25px; ">
					<h1 style="background-image: linear-gradient(red, #262626); color: white; padding: 10px">Contact Us Report</h1>
