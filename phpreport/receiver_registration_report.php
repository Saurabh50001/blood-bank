		...
		<div>
			...
			<center style="background-color: aqua;">
				<div style="width: 90%; border: 2px solid orangered; margin-top: 35px; margin-bottom: 35px; padding: 20px; border-radius: 25px; ">
					<h1 style="background-image: linear-gradient(red, #262626); color: white; padding: 10px">Receiver Registration Report</h1>
			...
			?>
			<tr>
				<td><?php echo $row["receicerid"];?></td>
				<td><?php echo $row["receicername"];?></td>
